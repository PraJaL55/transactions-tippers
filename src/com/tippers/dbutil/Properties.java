...
public final class Properties {
	public static final String SET_DB_PARAMS = "SET statement_timeout = 0;" + 
			"SET lock_timeout = 0;" + 
	...
	public static final int CORE_POOL_SIZE = 40; //should always be less than equal to MPL_LEVEL
	public static final int MPL_LEVEL = 40;
	public static final int KEEP_ALIVE_TIME = 10;
	public static final boolean CONNECT_TO_PSQL = true; //if false it will connect to MySQL
	public static final int OPERATIONS_PER_TXN = 20; //change this value to increase operation counts
